...
The QGIS documentation is available `here <https://docs.qgis.org/latest/en/docs/user_manual/>`_. The following QGIS plugins are useful tools for editing and working with QWAT data :

* `History viewer <https://plugins.qgis.org/plugins/pg_history_viewer/>`_ : a simple tool to audit latest editions in QWAT.
